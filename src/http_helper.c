...
static const struct HTTP_ROUTE ALLOWED_ROUTES[] = {
    { HTTP_GET, "settings", ESP_PAGE_OPEN, HTML_SETTINGS, 35395, ESP_VOID_HANDLER },
    { HTTP_GET, "network", ESP_PAGE_OPEN, NULL, 0, ESP_VOID_HANDLER },
    { HTTP_POST, "network", ESP_PAGE_OPEN, NULL, 0, ESP_CONNECT_WIFI },
    { HTTP_GET, "networks", ESP_PAGE_OPEN, NULL, 0, ESP_GET_WIFI_LIST },
    { HTTP_POST, "wifi-mode", ESP_PAGE_OPEN, NULL, 0, ESP_WIFI_MODE },
    { HTTP_POST, "conf-mode", ESP_PAGE_OPEN, NULL, 0, ESP_CONF_MODE },
    { HTTP_GET, "device-conf", ESP_PAGE_OPEN, NULL, 0, ESP_GET_DEVICE_CONF },
    { HTTP_POST, "device-conf", ESP_PAGE_OPEN, NULL, 0, ESP_SET_DEVICE_CONF }
};
