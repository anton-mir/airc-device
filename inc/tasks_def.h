...
#define ANALOG_TEMP_TASK_STACK_SIZE         (configMINIMAL_STACK_SIZE * 3)
...
#define DISPLAY_DATA_TASK_PRIO         (tskIDLE_PRIORITY + 1)
#define DISPLAY_DATA_TASK_STACK_SIZE   (configMINIMAL_STACK_SIZE * 3)
#endif /* TASKS_DEF_H */
