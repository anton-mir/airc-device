...
#define ESP8266_WIFI_TASK_PRIO          (tskIDLE_PRIORITY + 2)
#define ESP8266_WIFI_TASK_STACK_SIZE    (configMINIMAL_STACK_SIZE * 4)

#define ESP8266_UART_RX_TASK_PRIO          (tskIDLE_PRIORITY + 1)
#define ESP8266_UART_RX_TASK_STACK_SIZE    (configMINIMAL_STACK_SIZE * 2)
